...
def compare_weeks(week):
    ...
    last_green_batch = green_20.batch_get(['H2:H5'])
    ...
    last_green_week_1 = int(last_green_batch[0][0][0])
    loggerhead_week_1 = int(new_logger_batch[0][0][0])
    last_loggerhead_week_1 = int(last_logger_batch[0][0][0])

    total_week_2 = int(raw_batch[0][1][0])
    last_total_week_2 = int(raw_20_batch[0][1][0])
    green_week_2 = int(new_green_batch[0][1][0])
    last_green_week_2 = int(last_green_batch[0][1][0])
    loggerhead_week_2 = int(new_logger_batch[0][1][0])
    last_loggerhead_week_2 = int(last_logger_batch[0][1][0])

    total_week_3 = int(raw_batch[0][2][0])
    last_total_week_3 = int(raw_20_batch[0][2][0])
    green_week_3 = int(new_green_batch[0][2][0])
    last_green_week_3 = int(last_green_batch[0][2][0])
    loggerhead_week_3 = int(new_logger_batch[0][2][0])
    last_loggerhead_week_3 = int(last_logger_batch[0][2][0])

    total_week_final = int(raw_batch[0][3][0])
    last_total_week_final = int(raw_20_batch[0][3][0])
    green_week_final = int(new_green_batch[0][3][0])
    last_green_week_final = int(last_green_batch[0][3][0])
    loggerhead_week_final = int(new_logger_batch[0][3][0])
    last_loggerhead_week_final = int(last_logger_batch[0][3][0])
